...
const DersTakvimi1 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const scheduleRes = await axios.get('http://localhost:8800/dersTakvimi1');
  ...
  const handleAddSchedule = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:8800/dersTakvimi1', newCourseData);
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            try {
              await axios.delete('http://localhost:8800/dersTakvimi1/' + id);
              window.location.reload();
            } catch (error) {
              console.log(error);
            }
  ...
  const handleUpdateSchedule = async (e) => {
    ...
    try {
      const response = await axios.put("http://localhost:8800/dersTakvimi1/" + currentCourse.courseCalendarID, updatedCourseData);
      if (response.status === 200) {
